...
class _App3State extends State <App3>{
  ...
  Future <void> _init() async {
    ...
    String path = pathLib.join(getDatabasesPath, 'demo.db');
  ...
  Future <void> deletedDB() async{
    var getDatabasesPath = await getDbPath;
    await deleteDatabase(pathLib.join(getDatabasesPath, 'demo.db'));
  }
  ...
  Future<void> insertIntoDB() async{
    await db.transaction((txn) async{
      int id1 = await txn.rawInsert('INSERT INTO Test (name,value,num) VALUES ("some name", ${math.Random().nextInt(1000)}, ${math.Random().nextDouble()})');
      print('inserted: $id1');
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      : FutureBuilder(future: getDataFromDB(), 
